...
#if CONFIG_DONGLE_SCREEN_PERIPHERAL_STATUS_ACTIVE
...
#if CONFIG_DONGLE_SCREEN_PERIPHERAL_STATUS_ACTIVE
    // Peripheral connection dots: same row as the WPM number (y=20), centered
    // horizontally between the WPM text on the left and the USB/BLE labels on the right.
    // Screen is 280 px wide; WPM ends ~x=60, transport text starts ~x=220 → midpoint=140=center.
